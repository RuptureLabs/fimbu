...
from fimbu.cli import FimbuGroup


if TYPE_CHECKING:
    from typing import Optional
    from fimbu.locale.core import Babel
...
class BabelCli:
    ...
    def __init__(self, babel: Babel) -> None:
        ...
        Args:
            babel_configs (RootConfigs): `Babel` configs for using.
        """
        self.babel = babel
    ...
    def get_babel_cli(self):
        from click import echo, option, group

        @group(cls=FimbuGroup, name="babel",
            help="""
