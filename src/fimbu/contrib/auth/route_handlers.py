...
def get_registration_handler(
    ...
    async def register(data: DTOData[UserRegisterT], service: UserServiceType, request: Request) -> UserT:
        """Register a new user."""
        return cast(UserT, await service.register(data.as_builtins(), request))
...
def get_auth_handler(
    login_path: str,
    logout_path: str,
    user_read_dto: type[PydanticDTO],  # pyright: ignore
...
def get_current_user_handler(
    path: str,
    user_read_dto: type[PydanticDTO],  # pyright: ignore
    user_update_dto: type[PydanticDTO],  # pyright: ignore
    tags: list[str] | None = None,
) -> Router:
...
def get_user_management_handler(
    ...
    async def update_user(id_: UUID, data: UserT, service: UserServiceType) -> UserT:
        ...
        data.id = id_
        return cast(UserT, await service.update_user(data))
...
def get_role_management_handler(
    ...
    guards: list["Guard"],
    opt: dict[str, Any],
    role_create_dto: type[PydanticDTO],  # pyright: ignore
    role_read_dto: type[PydanticDTO],  # pyright: ignore
    role_update_dto: type[PydanticDTO],  # pyright: ignore
    user_read_dto: type[PydanticDTO],  # pyright: ignore
    tags: list[str] | None = None,
) -> Router:
