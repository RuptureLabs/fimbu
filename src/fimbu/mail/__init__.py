...
from fimbu.mail.config import ConnectionConfig
from fimbu.mail.connection import Connection
from fimbu.mail.errors import PydanticClassRequired
from fimbu.mail.messages import MailMessage
from fimbu.mail.schemas import MessageSchema
from fimbu.mail.schemas import MessageSchema, MessageType, MultipartSubtypeEnum
from .utils import DefaultChecker, WhoIsXmlApi
...
class FimbuMail(_MailMixin):
    """
    FimbuMail builds the message from the config
    """
